<div class="score w-full md:w-1/2">
	...
	<div class="border-t border-gray-200 dark:border-gray-650 px-4 h-16">
		<div class="h-full flex items-center justify-center">
			@if ($reg->played())
                <x-buttons.primary-outline class="w-24 uppercase text-xs px-2 py-0.5 leading-5 transform hover:scale-125 focus:scale-125 transition duration-300 ease-in-out" wire:click.prevent="openBoxscoreModal({{ $reg->id }})">
                    boxscore
