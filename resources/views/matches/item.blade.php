<div class="flex group cursor-pointer" wire:click="viewMatch({{ $reg->id }})">
	...
	<div class="ml-4 bg-white dark:bg-gray-750 dark:text-white shadow-md rounded mb-6 w-2/6 hidden lg:block group-hover:bg-gray-50 dark:group-hover:bg-gray-700 border border-transparent group-hover:border-gray-300 dark:group-hover:border-gray-550">
