<x-guest-layout>
    <div class="py-6 md:py-16 flex flex-col items-center mx-4 lg:mx-0">
        ...
        <a class="my-4 underline text-sm text-gray-600 dark:text-gray-100 hover:text-gray-900 dark:hover:text-gray-300 focus:text-gray-900 dark:focus:text-gray-300 focus:outline-none" href="{{ URL::previous() }}">
            {{ __('VOLVER ATRAS') }}
        </a>
    </div>
</x-guest-layout>