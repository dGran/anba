    ...
    <div class="btn-group" role="group">
        <div class="btn-group" role="group">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item d-flex align-items-center" wire:click="confirmExportSelectedToFile('xls')">
                    <i class="bx bxs-file-export mr-2"></i>Exportar (.xls)
                </a>
                <a class="dropdown-item d-flex align-items-center" wire:click="confirmExportSelectedToFile('xlsx')">
                    <i class="bx bxs-file-export mr-2"></i>Exportar (.xlsx)
                </a>
                <a class="dropdown-item d-flex align-items-center" wire:click="confirmExportSelectedToFile('csv')">
                    <i class="bx bxs-file-export mr-2"></i>Exportar (.csv)
                </a>
...
<ul class="applied-filters list-inline my-2">
    @if ($search !== TableFilters::VALUE_NULL_STRING)
    <li class="filter list-inline-item mr-1">
    ...
    <li class="filter list-inline-item">
