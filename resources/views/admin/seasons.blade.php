...
<div class="py-2"> {{-- slot --}}
    ...
    @include('admin.seasons.filters')
    @include('admin.seasons.table')

    {{-- modals --}}
    @include('admin.seasons.modals.add')
    @include('admin.seasons.modals.edit')
    @include('admin.seasons.modals.filters')
    @include('admin.seasons.modals.view')
    ...
    @if (config('adminlte.right_sidebar'))
        <aside class="control-sidebar control-sidebar-{{ config('adminlte.right_sidebar_theme') }} shadow overflow-auto">
            @include('admin.seasons.right-sidebar')
        </aside>
    @endif
