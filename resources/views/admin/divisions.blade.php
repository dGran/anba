...
<div class="py-2"> {{-- slot --}}
    ...
    @include('admin.divisions.filters')
    @include('admin.divisions.table')

    {{-- modals --}}
    @include('admin.divisions.modals.add')
    @include('admin.divisions.modals.edit')
    @include('admin.divisions.modals.filters')
    @include('admin.divisions.modals.view')
    ...
    @if (config('adminlte.right_sidebar'))
        <aside class="control-sidebar control-sidebar-{{ config('adminlte.right_sidebar_theme') }} shadow overflow-auto">
            @include('admin.divisions.right-sidebar')
        </aside>
    @endif
