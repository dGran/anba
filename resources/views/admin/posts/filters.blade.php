<div class="filters d-flex align-items-center non-selectable">
	...
	<button type="button" class="btn btn-new d-md-flex align-items-center mr-2" wire:click="add" wire:loading.attr="disabled">
		<i class="bx bxs-add-to-queue"></i><span class="ml-2 d-none d-md-inline-flex">Nueva</span>
	</button>
	...
	<div class="btn-group" role="group">
		...
		<button type="button" class="btn btn-white {{ $order != "id_desc" || $search || $filterType != "all" || $perPage != "25" ?: 'disabled' }}" wire:click="clearAllFilters">
...
@if ($search || $filterType != "all" || $perPage != "25")
