...
{{--                     @if ( ($total_scores['local'] + $total_scores['visitor']) == $players_stats->sum('PTS') )
                    ...
                    @if ( ($total_scores['local'] > 0 && $total_scores['visitor'] > 0 && ($total_scores['local'] != $total_scores['visitor'])) || $regView->playerStats->count() > 0 || $regView->teamStats->count() > 0)
                                            ...
                                            @foreach ($players_stats as $key => $player)
                                                @if ($player['season_team_id'] == $regView->localTeam->id)
                                                    @php
                                                        ...
                                                        $field_shots_M += $players_stats[$key]['TPM'] ?: 0;
                                                        $field_shots_M += $players_stats[$key]['FTM'] ?: 0;
                                                        $field_shots_A = 0;
                                                        $field_shots_A += $players_stats[$key]['FGA'] ?: 0;
                                                        $field_shots_A += $players_stats[$key]['TPA'] ?: 0;
                                                        $field_shots_A += $players_stats[$key]['FTA'] ?: 0;
                                                    @endphp
                                                    <tr>
                                                        <td style="width: 200px; min-width: 200px; max-width: 200px" class="truncate">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="truncate">
                                                                    ...
                                                                    <span class="truncate d-block text-gray-500 text-uppercase text-xxs">
                                                                        {{ $player['player_pos'] }}
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        @else
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="1" max="48" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control numericInput px-2 {{ $players_stats[$key]['MIN'] == null ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.MIN">
                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($players_stats[$key]['PTS'] == null && $players_stats[$key]['PTS'] !== 0) || $players_stats[$key]['PTS'] > 150 ? 'border-danger' : '' }} {{ $players_stats[$key]['MIN'] > 0 ? 'd-block' : 'd-none' }} form-control numericInput px-2 {{ $players_stats[$key]['PTS'] == null && $players_stats[$key]['PTS'] !== 0 ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.PTS">
                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($players_stats[$key]['REB'] == null && $players_stats[$key]['REB'] !== 0) || $players_stats[$key]['REB'] > 75 ? 'border-danger' : '' }} {{ $players_stats[$key]['MIN'] > 0 ? 'd-block' : 'd-none' }} form-control numericInput px-2 {{ $players_stats[$key]['REB'] == null && $players_stats[$key]['REB'] !== 0 ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.REB">
                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($players_stats[$key]['AST'] == null && $players_stats[$key]['AST'] !== 0) || $players_stats[$key]['AST'] > 55 ? 'border-danger' : '' }} {{ $players_stats[$key]['MIN'] > 0 ? 'd-block' : 'd-none' }} form-control numericInput px-2 {{ $players_stats[$key]['AST'] == null && $players_stats[$key]['AST'] !== 0 ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.AST">
                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($players_stats[$key]['STL'] == null && $players_stats[$key]['STL'] !== 0) || $players_stats[$key]['STL'] > 30 ? 'border-danger' : '' }} {{ $players_stats[$key]['MIN'] > 0 ? 'd-block' : 'd-none' }} form-control numericInput px-2 {{ $players_stats[$key]['STL'] == null && $players_stats[$key]['STL'] !== 0 ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.STL">
                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($players_stats[$key]['BLK'] == null && $players_stats[$key]['BLK'] !== 0) || $players_stats[$key]['BLK'] > 25 ? 'border-danger' : '' }} {{ $players_stats[$key]['MIN'] > 0 ? 'd-block' : 'd-none' }} form-control numericInput px-2 {{ $players_stats[$key]['BLK'] == null && $players_stats[$key]['BLK'] !== 0 ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.BLK">
                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($players_stats[$key]['LOS'] == null && $players_stats[$key]['LOS'] !== 0) || $players_stats[$key]['LOS'] > 50 ? 'border-danger' : '' }} {{ $players_stats[$key]['MIN'] > 0 ? 'd-block' : 'd-none' }} form-control numericInput px-2 {{ $players_stats[$key]['LOS'] == null && $players_stats[$key]['LOS'] !== 0 ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.LOS">
                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($players_stats[$key]['FGM'] == null && $players_stats[$key]['FGM'] !== 0) || ($players_stats[$key]['FGM'] > $players_stats[$key]['FGA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-danger' : '' }} {{ $players_stats[$key]['MIN'] > 0 ? 'd-block' : 'd-none' }} form-control numericInput px-2 {{ $players_stats[$key]['FGM'] == null && $players_stats[$key]['FGM'] !== 0 ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.FGM">

                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($players_stats[$key]['FGA'] == null && $players_stats[$key]['FGA'] !== 0) || ($players_stats[$key]['FGM'] > $players_stats[$key]['FGA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-danger' : '' }} {{ $players_stats[$key]['MIN'] > 0 ? 'd-block' : 'd-none' }} form-control numericInput px-2 {{ $players_stats[$key]['FGA'] == null && $players_stats[$key]['FGA'] !== 0 ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.FGA">
                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($players_stats[$key]['TPM'] == null && $players_stats[$key]['TPM'] !== 0) || ($players_stats[$key]['TPM'] > $players_stats[$key]['TPA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-danger' : '' }} {{ $players_stats[$key]['MIN'] > 0 ? 'd-block' : 'd-none' }} form-control numericInput px-2 {{ $players_stats[$key]['TPM'] == null && $players_stats[$key]['TPM'] !== 0 ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.TPM">
                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($players_stats[$key]['TPA'] == null && $players_stats[$key]['TPA'] !== 0) || ($players_stats[$key]['TPM'] > $players_stats[$key]['TPA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-danger' : '' }} {{ $players_stats[$key]['MIN'] > 0 ? 'd-block' : 'd-none' }} form-control numericInput px-2 {{ $players_stats[$key]['TPA'] == null && $players_stats[$key]['TPA'] !== 0 ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.TPA">
                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($players_stats[$key]['FTM'] == null && $players_stats[$key]['FTM'] !== 0) || ($players_stats[$key]['FTM'] > $players_stats[$key]['FTA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-danger' : '' }} {{ $players_stats[$key]['MIN'] > 0 ? 'd-block' : 'd-none' }} form-control numericInput px-2 {{ $players_stats[$key]['FTM'] == null && $players_stats[$key]['FTM'] !== 0 ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.FTM">
                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($players_stats[$key]['FTA'] == null && $players_stats[$key]['FTA'] !== 0) || ($players_stats[$key]['FTM'] > $players_stats[$key]['FTA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-danger' : '' }} {{ $players_stats[$key]['MIN'] > 0 ? 'd-block' : 'd-none' }} form-control numericInput px-2 {{ $players_stats[$key]['FTA'] == null && $players_stats[$key]['FTA'] !== 0 ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.FTA">
                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ $players_stats[$key]['ORB'] == null && $players_stats[$key]['ORB'] !== 0 ? 'border-danger' : '' }} {{ $players_stats[$key]['MIN'] > 0 ? 'd-block' : 'd-none' }} form-control numericInput px-2 {{ $players_stats[$key]['ORB'] == null && $players_stats[$key]['ORB'] !== 0 ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.ORB">
                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ $players_stats[$key]['PF'] == null && $players_stats[$key]['PF'] !== 0 ? 'border-danger' : '' }} {{ $players_stats[$key]['MIN'] > 0 ? 'd-block' : 'd-none' }} form-control numericInput px-2 {{ $players_stats[$key]['PF'] == null && $players_stats[$key]['PF'] !== 0 ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.PF">
                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                                                                <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($players_stats[$key]['ML'] == null && $players_stats[$key]['ML'] !== 0) || $players_stats[$key]['ML'] > 150 ? 'border-danger' : '' }} {{ $players_stats[$key]['MIN'] > 0 ? 'd-block' : 'd-none' }} form-control numericInput px-2 {{ $players_stats[$key]['ML'] == null && $players_stats[$key]['ML'] !== 0 ? 'bg-light' : '' }}" placeholder="-" wire:model="players_stats.{{ $key }}.ML">
                                                            </td>
                                                            <td style="width: 90px; min-width: 90px">
                ...
                <div class="modal-footer" style="background: #F9FAFB">
                    ...
                    @if ($editBoxscoreMode)
                        <button type="button" class="btn btn-primary ml-2 text-xs text-uppercase tracking-widest" {{ $total_scores['local'] > 0 && $total_scores['visitor'] > 0 && ($total_scores['local'] != $total_scores['visitor']) ? '' : 'disabled' }} wire:click="updateMatch({{ $regView->id }})">
                            Actualizar
                        </button>
                    @else
                        <button type="button" class="btn btn-primary ml-2 text-xs text-uppercase tracking-widest" {{ $total_scores['local'] > 0 && $total_scores['visitor'] > 0 && ($total_scores['local'] != $total_scores['visitor']) ? '' : 'disabled' }} wire:click="storeMatch">
                            Guardar
                        </button>
                    @endif
                </div>
