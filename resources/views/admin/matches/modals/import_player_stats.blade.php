<div wire:ignore.self class="modal fade" tabindex="-1" role="dialog" id="importPlayerStatsModal" data-keyboard="true" data-backdrop="static">
    <form wire:submit.prevent="importPlayerStats" enctype="multipart/form-data">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-base text-uppercase font-medium tracking-wide">
                        <span>Importar estadísticas de jugadores</span>
                    </h5>
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="font-weight-bold m-0 mb-1 text-center">Los registros con ids inválidas de partido, equipo o jugador serán ignorados.</p>
