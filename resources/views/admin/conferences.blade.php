...
<div class="py-2"> {{-- slot --}}
    ...
    @include('admin.conferences.table')

    {{-- modals --}}
    @include('admin.conferences.modals.add')
    @include('admin.conferences.modals.edit')
    @include('admin.conferences.modals.filters')
    @include('admin.conferences.modals.view')
    ...
    @if (config('adminlte.right_sidebar'))
        <aside class="control-sidebar control-sidebar-{{ config('adminlte.right_sidebar_theme') }} shadow overflow-auto">
            @include('admin.conferences.right-sidebar')
        </aside>
    @endif
