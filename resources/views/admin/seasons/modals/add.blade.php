        ...
        <div class="modal-content">
            ...
            <form wire:submit.prevent="store" enctype="multipart/form-data">
                <div class="modal-body">
                    @include('admin.seasons.forms.form')
                    <p class="text-sm m-0 font-weight-bold">
                        *Se agregarán automaticamente a la temporada todos los equipos activos actuales con sus divisiones y conferencias relacionadas.
                    </p>
                </div>
