<div class="filters d-flex align-items-center non-selectable">
	...
	<div class="btn-group" role="group">
		<div class="btn-group" role="group">
			...
			<div class="dropdown-menu dropdown-menu-right">
	            ...
	            @if ($regsSelected->count() == 1)
	            	...
	            	@if (!$regsSelected->first()->current)
            			<div class="dropdown-divider"></div>
			            <a class="dropdown-item d-flex align-items-center" wire:click="current({{ $regsSelected->first()->id }})">
			            	<i class="fas fa-check mr-2"></i></i>Establecer temporada activa
			            </a>
	            	@endif
	            @endif
		...
		<button type="button" class="btn btn-white {{ $order != "id_desc" || $search || $perPage != "25" ?: 'disabled' }}" wire:click="clearAllFilters">
