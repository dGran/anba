...
<div class="py-2"> {{-- slot --}}
    ...
    @include('admin.injuries.filters')
    @include('admin.injuries.table')

    {{-- modals --}}
    @include('admin.injuries.modals.add')
    @include('admin.injuries.modals.edit')
    @include('admin.injuries.modals.filters')
    @include('admin.injuries.modals.view')
    ...
    @if (config('adminlte.right_sidebar'))
        <aside class="control-sidebar control-sidebar-{{ config('adminlte.right_sidebar_theme') }} shadow overflow-auto">
            @include('admin.injuries.right-sidebar')
        </aside>
    @endif
