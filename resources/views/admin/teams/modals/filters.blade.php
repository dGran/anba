            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control custom-select text-sm" wire:model="filterDivision">
            			...
            			<div class="form-group">
							...
							{{-- <div wire:ignore> --}}
								<select class="form-control custom-select text-sm" wire:model="order">
                                    ...
                                    <option value="medium_name">Nombre medio</option>
                                    <option value="medium_name_desc">Nombre medio (desc)</option>
                                    <option value="short_name">Nombre corto</option>
                                    <option value="short_name_desc">Nombre corto (desc)</option>
                                    <option value="division">División</option>
                                    <option value="division_desc">División (desc)</option>
									<option value="manager">Manager</option>
                                    <option value="manager_desc">Manager (desc)</option>
                                    <option value="stadium">Estadio</option>
                                    <option value="stadium_desc">Estadio (desc)</option>
								</select>
							{{-- </div> --}}
            			</div>
            			<!-- /.form-group -->
