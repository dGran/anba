...
@if ($search || $filterPosition != "all" || $filterTeam != "all" || $filterNation != "all" || $filterAge != ['from' => 15, 'to' => 45] || $filterHeight != ['from' => 5, 'to' => 8] || $filterWeight != ['from' => 125, 'to' => 500] || $filterYearDraft != ['from' => 1995, 'to' => 2020] || $filterCollege != "all" || $filterRetired != "all" || $filterOutNBA != "all" || $filterInjury != "all" || $perPage != "25")
	<ul class="list-inline my-2">
		...
		@if ($filterOutNBA != "all")
			<li class="list-inline-item mr-1">
				<a class="btn btn-white text-xxs text-uppercase" wire:click="cancelFilterOutNBA">
					Fuera de la NBA: {{ $filterOutNBAName }}<i class="fas fa-times ml-2"></i>
				<a>
			</li>
		@endif
		@if ($filterInjury != "all")
			<li class="list-inline-item mr-1">
				<a class="btn btn-white text-xxs text-uppercase" wire:click="cancelFilterInjury">
					{{ $filterInjury == "yes" ? 'lesionados' : 'no lesionados' }}<i class="fas fa-times ml-2"></i>
				<a>
			</li>
		@endif
		@if ($perPage !== "25")
