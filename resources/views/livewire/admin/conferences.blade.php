...
<div class="py-2"> {{-- slot --}}
    ...
    @include('livewire.admin.conferences.table')

    {{-- modals --}}
    @include('livewire.admin.conferences.modals.add')
    @include('livewire.admin.conferences.modals.edit')
    @include('livewire.admin.conferences.modals.filters')
    @include('livewire.admin.conferences.modals.view')
    ...
    @if (config('adminlte.right_sidebar'))
        <aside class="control-sidebar control-sidebar-{{ config('adminlte.right_sidebar_theme') }} shadow overflow-auto">
            @include('livewire.admin.conferences.right-sidebar')
        </aside>
    @endif
