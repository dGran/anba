	...
	<div class="px-3 py-4 border-bottom">
	    ...
	    <div class="pretty p-svg p-curve m-0 p-smooth p-has-focus text-xs d-block mb-2">
	        ...
	        <div class="state p-primary">
	            ...
	            <label class="text-uppercase tracking-widest ml-1">Tipo</label>
	        </div>
	    </div>
	    <div class="pretty p-svg p-curve m-0 p-smooth p-has-focus text-xs d-block mb-2">
	        ...
	        <div class="state p-primary">
	            ...
	            <label class="text-uppercase tracking-widest ml-1">Tabla</label>
	        </div>
	    </div>
	    <div class="pretty p-svg p-curve m-0 p-smooth p-has-focus text-xs d-block mb-2">
	    ...
	    <div class="pretty p-svg p-curve m-0 p-smooth p-has-focus text-xs d-block mb-2">
	        ...
	        <div class="state p-primary">
	            ...
	            <label class="text-uppercase tracking-widest ml-1">Fecha</label>
	        </div>
	    </div>
	</div>
