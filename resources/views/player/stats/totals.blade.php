                ...
                <table class="summary-player-stats font-roboto">
                    <thead>
                        <tr class="text-gray-600 bg-gray-200 dark:bg-gray-700 dark:text-gray-100 select-none">
                            ...
                            {{ $statsTotals_order == 'seasons.name' ? 'bg-gray-800 text-white dark:bg-gray-650' : 'bg-gray-200 dark:bg-gray-700 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-650 ' }}
                            ...
                            <th class="cursor-pointer
                            {{ $statsTotals_order == 'team_name' ? 'bg-gray-800 text-white dark:bg-gray-650' : 'bg-gray-200 dark:bg-gray-700 hover:bg-gray-800 hover:text-white dark:hover:bg-gray-650 ' }}
                    ...
                    <tbody wire:loading.class="opacity-75">
                        @foreach ($statsTotals as $key=>$stat)
                            <tr class="group hover:bg-gray-100 dark:hover:bg-gray-700 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <td class="{{ $statsTotals_order == 'team_name' ? 'bg-gray-150 dark:bg-gray-650' : 'bg-white dark:bg-gray-750 group-hover:bg-gray-100 dark:group-hover:bg-gray-700' }}"
                                    style="left: 6.25rem; position: sticky; position: -webkit-sticky; text-align: left;">
