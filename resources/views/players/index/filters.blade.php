<div class="flex flex-col md:flex-row space-x-0 md:space-x-0.5 items-center select-none | mb-2 | overflow-x-auto">
    ...
    <div class="flex-1 w-full flex flex-col relative">
        ...
        <select id="fposition" class="appearance-none sm:rounded text-sm text-blue-500 dark:text-dark-link font-bold | h-12 md:h-16 pt-4 px-3 | bg-white dark:bg-gray-700 | border-t border-b sm:border border-gray-200 dark:border-gray-850 focus:border-gray-300 hover:border-gray-300 hover:bg-gray-50 focus:bg-gray-50 dark:focus:border-gray-600 dark:hover:border-gray-600 dark:hover:bg-gray-650 dark:focus:bg-gray-650 | focus:outline-none" wire:model="fposition" wire:change="applyFilter">
    ...
    <div class="flex-1 w-full flex flex-col relative">
        ...
        <select id="fnation" class="appearance-none sm:rounded text-sm text-blue-500 dark:text-dark-link font-bold | h-12 md:h-16 pt-4 px-3 | bg-white dark:bg-gray-700 | border-t border-b sm:border border-gray-200 dark:border-gray-850 focus:border-gray-300 hover:border-gray-300 hover:bg-gray-50 focus:bg-gray-50 dark:focus:border-gray-600 dark:hover:border-gray-600 dark:hover:bg-gray-650 dark:focus:bg-gray-650 | focus:outline-none" wire:model="fnation" wire:change="applyFilter">
    ...
    <div class="flex-1 w-full flex flex-col relative">
        ...
        <select id="fcollege" class="appearance-none sm:rounded text-sm text-blue-500 dark:text-dark-link font-bold | h-12 md:h-16 pt-4 px-3 | bg-white dark:bg-gray-700 | border-t border-b sm:border border-gray-200 dark:border-gray-850 focus:border-gray-300 hover:border-gray-300 hover:bg-gray-50 focus:bg-gray-50 dark:focus:border-gray-600 dark:hover:border-gray-600 dark:hover:bg-gray-650 dark:focus:bg-gray-650 | focus:outline-none" wire:model="fcollege" wire:change="applyFilter">
    ...
    <div class="flex-1 w-full flex flex-col relative" style="min-width: 8rem">
        ...
        <select id="fstate" class="appearance-none sm:rounded text-sm text-blue-500 dark:text-dark-link font-bold | h-12 md:h-16 pt-4 px-3 | bg-white dark:bg-gray-700 | border-t border-b sm:border border-gray-200 dark:border-gray-850 focus:border-gray-300 hover:border-gray-300 hover:bg-gray-50 focus:bg-gray-50 dark:focus:border-gray-600 dark:hover:border-gray-600 dark:hover:bg-gray-650 dark:focus:bg-gray-650 | focus:outline-none" wire:model="fstate" wire:change="applyFilter">
    ...
    <div class="flex-1 w-full flex flex-col relative" style="min-width: 8rem">
        ...
        <select id="foutnba" class="appearance-none sm:rounded text-sm text-blue-500 dark:text-dark-link font-bold | h-12 md:h-16 pt-4 px-3 | bg-white dark:bg-gray-700 | border-t border-b sm:border border-gray-200 dark:border-gray-850 focus:border-gray-300 hover:border-gray-300 hover:bg-gray-50 focus:bg-gray-50 dark:focus:border-gray-600 dark:hover:border-gray-600 dark:hover:bg-gray-650 dark:focus:bg-gray-650 | focus:outline-none" wire:model="foutnba" wire:change="applyFilter">
...
<div class="mb-4">
    <div class="flex flex-col md:flex-row items-center select-none">
        <div class="flex-1 w-full flex flex-col relative mt-0.5 md:mt-0">
            ...
            <input type="search" id="search" wire:model="search" class="appearance-none sm:rounded text-sm text-blue-500 dark:text-dark-link font-bold | h-12 md:h-16 pt-4 px-3 | bg-white dark:bg-gray-700 | border-t border-b sm:border border-gray-200 dark:border-gray-850 focus:border-gray-300 hover:border-gray-300 hover:bg-gray-50 focus:bg-gray-50 dark:focus:border-gray-600 dark:hover:border-gray-600 dark:hover:bg-gray-650 dark:focus:bg-gray-650 | focus:outline-none" placeholder="nombre, equipo, universidad..." autofocus="true">
        </div>
    </div>
</div>
