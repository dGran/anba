@if ($players->total() > 0)
    <div class="flex items-center justify-end | text-xs md:text-sm | px-3 sm:px-0">
        ...
        <div class="pl-3 | flex items-center space-x-0">
            ...
            <select class="appearance-none font-bold | h-9 w-12 | bg-white dark:bg-gray-750 hover:bg-gray-200 dark:hover:bg-gray-700 focus:bg-gray-200 dark:focus:bg-gray-700 | border-t border-b border-gray-200 dark:border-gray-650 | focus:outline-none" wire:model="page" wire:change="setCurrentPage" style="    text-align:-moz-center; text-align:-webkit-center;">
