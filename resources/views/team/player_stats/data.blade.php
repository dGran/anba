                ...
                <tbody wire:loading.class="opacity-75">
                    @foreach ($players_stats as $key=>$stat)
                        <tr class="group hover:bg-gray-100 dark:hover:bg-gray-700 border-t border-gray-200 dark:border-gray-700">
                            <td class="w-56 truncate {{ $order == 'player_name' ? 'bg-gray-150 dark:bg-gray-650' : 'bg-white dark:bg-gray-750 group-hover:bg-gray-100 dark:group-hover:bg-gray-700' }}" style="width: 14rem; min-width: 14rem; max-width: 14rem; left: 0px; position: sticky; position: -webkit-sticky; text-align: left;">
                            ...
                            <td class="text-right {{ $order == 'AGE' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                {{ $stat->AGE ?: 'N/D' }}
                            </td>
                            <td class="text-right {{ $order == 'PJ' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                {{ number_format($stat->PJ, 0, ',', '.') }}
                            </td>
                            <td class="text-right {{ $order == 'PT' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                {{ number_format($stat->PT, 0, ',', '.') }}
                            </td>
                            <td class="text-right {{ $order == 'AVG_MIN' || $order == 'SUM_MIN' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'AVG_PTS' || $order == 'SUM_PTS' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'AVG_FGM' || $order == 'SUM_FGM' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'AVG_FGA' || $order == 'SUM_FGA' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'PER_FG' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                {{ number_format($stat->PER_FG, 1, ',', '.') }}
                            </td>
                            <td class="text-right {{ $order == 'AVG_TPM' || $order == 'SUM_TPM' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'AVG_TPA' || $order == 'SUM_TPA' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'PER_TP' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                {{ number_format($stat->PER_TP, 1, ',', '.') }}
                            </td>
                            <td class="text-right {{ $order == 'AVG_FTM' || $order == 'SUM_FTM' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'AVG_FTA' || $order == 'SUM_FTA' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'PER_FT' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                {{ number_format($stat->PER_FT, 1, ',', '.') }}
                            </td>
                            <td class="text-right {{ $order == 'AVG_ORB' || $order == 'SUM_ORB' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'AVG_DRB' || $order == 'SUM_DRB' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'AVG_REB' || $order == 'SUM_REB' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'AVG_AST' || $order == 'SUM_AST' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'AVG_STL' || $order == 'SUM_STL' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'AVG_LOS' || $order == 'SUM_LOS' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'AVG_BLK' || $order == 'SUM_BLK' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'AVG_PF' || $order == 'SUM_PF' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
                            ...
                            <td class="text-right {{ $order == 'AVG_ML' || $order == 'SUM_ML' ? 'bg-gray-150 dark:bg-gray-650' : '' }}">
                                @if ($mode == 'per_game')
