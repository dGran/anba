		...
		<div class="flex mb-4 mt-2">
			<div class="flex-1 border-r border-gray-200 dark:border-gray-650 py-1">
				<div class="px-1 flex items-center border-b border-gray-200 dark:border-gray-650">
					<img src="{{ $match->localTeam->team->getImg() }}" alt="{{ $match->localTeam->team->short_name }}" style="width: 32px; height: 32px">
					<div class="text-sm ml-2">{{ $match->localTeam->team->medium_name }}</div>
				</div>
			...
			<div class="flex-1 py-1">
				<div class="px-1 flex items-center justify-end border-b border-gray-200 dark:border-gray-650">
					<div class="text-sm mr-2">{{ $match->visitorTeam->team->medium_name }}</div>
					<img src="{{ $match->visitorTeam->team->getImg() }}" alt="{{ $match->visitorTeam->team->short_name }}" style="width: 32px; height: 32px">
				</div>
				<div class="text-center">
