                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                                    ...
                                    <tr class="border-t border-gray-150 dark:border-gray-650">
                                        ...
                                        @else
                                            ...
                                            <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                                ...
                                                <p class="{{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} {{ $show_players_stats_totals_inline ?: 'hidden' }} text-center text-xs pt-1 text-gray-500">Total: {{ $local_players_stats_totals['REB'] }}</p>
                                            </td>
                                            <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                                ...
                                                <p class="{{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} {{ $show_players_stats_totals_inline ?: 'hidden' }} text-center text-xs pt-1 text-gray-500">Total: {{ $local_players_stats_totals['AST'] }}</p>
                                            </td>
                                            <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                                ...
                                                <p class="{{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} {{ $show_players_stats_totals_inline ?: 'hidden' }} text-center text-xs pt-1 text-gray-500">Total: {{ $local_players_stats_totals['STL'] }}</p>
                                            </td>
                                            <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                                <input type="number" min="0" max="25" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($local_players_stats[$key]['BLK'] == null && $local_players_stats[$key]['BLK'] !== 0) || $local_players_stats[$key]['BLK'] > 25 ? 'border-pretty-red dark:border-pretty-red' : 'border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550' }} {{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} w-16 appearance-none rounded text-sm | py-1.5 px-2.5 | bg-white dark:bg-gray-700 | border | focus:outline-none px-2 {{ $local_players_stats[$key]['BLK'] == null && $local_players_stats[$key]['BLK'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="TAP" wire:model="local_players_stats.{{ $key }}.BLK">
                                                <p class="{{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} {{ $show_players_stats_totals_inline ?: 'hidden' }} text-center text-xs pt-1 text-gray-500">Total: {{ $local_players_stats_totals['BLK'] }}</p>
                                            </td>
                                            <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                                <input type="number" min="0" max="50" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($local_players_stats[$key]['LOS'] == null && $local_players_stats[$key]['LOS'] !== 0) || $local_players_stats[$key]['LOS'] > 50 ? 'border-pretty-red dark:border-pretty-red' : 'border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550' }} {{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} w-16 appearance-none rounded text-sm | py-1.5 px-2.5 | bg-white dark:bg-gray-700 | border | focus:outline-none px-2 {{ $local_players_stats[$key]['LOS'] == null && $local_players_stats[$key]['LOS'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="PER" wire:model="local_players_stats.{{ $key }}.LOS">
                                                <p class="{{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} {{ $show_players_stats_totals_inline ?: 'hidden' }} text-center text-xs pt-1 text-gray-500">Total: {{ $local_players_stats_totals['LOS'] }}</p>
                                            </td>
                                            <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($local_players_stats[$key]['FGM'] == null && $local_players_stats[$key]['FGM'] !== 0) || ($local_players_stats[$key]['FGM'] > $local_players_stats[$key]['FGA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-pretty-red dark:border-pretty-red' : 'border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550' }} {{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} w-16 appearance-none rounded text-sm | py-1.5 px-2.5 | bg-white dark:bg-gray-700 | border | focus:outline-none px-2 {{ $local_players_stats[$key]['FGM'] == null && $local_players_stats[$key]['FGM'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="FGM" wire:model="local_players_stats.{{ $key }}.FGM">
                                                <p class="{{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} {{ $show_players_stats_totals_inline ?: 'hidden' }} text-center text-xs pt-1 text-gray-500">Total: {{ $local_players_stats_totals['FGM'] }}</p>
                                            </td>
                                            <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($local_players_stats[$key]['FGA'] == null && $local_players_stats[$key]['FGA'] !== 0) || ($local_players_stats[$key]['FGM'] > $local_players_stats[$key]['FGA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-pretty-red dark:border-pretty-red' : 'border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550' }} {{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} w-16 appearance-none rounded text-sm | py-1.5 px-2.5 | bg-white dark:bg-gray-700 | border | focus:outline-none px-2 {{ $local_players_stats[$key]['FGA'] == null && $local_players_stats[$key]['FGA'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="FGA" wire:model="local_players_stats.{{ $key }}.FGA">
                                                <p class="{{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} {{ $show_players_stats_totals_inline ?: 'hidden' }} text-center text-xs pt-1 text-gray-500">Total: {{ $local_players_stats_totals['FGA'] }}</p>
                                            </td>
                                            <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                                ...
                                                <p class="{{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} {{ $show_players_stats_totals_inline ?: 'hidden' }} text-center text-xs pt-1 text-gray-500">Total: {{ $local_players_stats_totals['TPM'] }}</p>
                                            </td>
                                            <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($local_players_stats[$key]['TPA'] == null && $local_players_stats[$key]['TPA'] !== 0) || ($local_players_stats[$key]['TPM'] > $local_players_stats[$key]['TPA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-pretty-red dark:border-pretty-red' : 'border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550' }} {{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} w-16 appearance-none rounded text-sm | py-1.5 px-2.5 | bg-white dark:bg-gray-700 | border | focus:outline-none px-2 {{ $local_players_stats[$key]['TPA'] == null && $local_players_stats[$key]['TPA'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="3PA" wire:model="local_players_stats.{{ $key }}.TPA">
                                                <p class="{{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} {{ $show_players_stats_totals_inline ?: 'hidden' }} text-center text-xs pt-1 text-gray-500">Total: {{ $local_players_stats_totals['TPA'] }}</p>
                                            </td>
                                            <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($local_players_stats[$key]['FTM'] == null && $local_players_stats[$key]['FTM'] !== 0) || ($local_players_stats[$key]['FTM'] > $local_players_stats[$key]['FTA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-pretty-red dark:border-pretty-red' : 'border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550' }} {{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} w-16 appearance-none rounded text-sm | py-1.5 px-2.5 | bg-white dark:bg-gray-700 | border | focus:outline-none px-2 {{ $local_players_stats[$key]['FTM'] == null && $local_players_stats[$key]['FTM'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="TLM" wire:model="local_players_stats.{{ $key }}.FTM">
                                                <p class="{{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} {{ $show_players_stats_totals_inline ?: 'hidden' }} text-center text-xs pt-1 text-gray-500">Total: {{ $local_players_stats_totals['FTM'] }}</p>
                                            </td>
                                            <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                                ...
                                                <p class="{{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} {{ $show_players_stats_totals_inline ?: 'hidden' }} text-center text-xs pt-1 text-gray-500">Total: {{ $local_players_stats_totals['FTA'] }}</p>
                                            </td>
                                            <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ $local_players_stats[$key]['ORB'] == null && $local_players_stats[$key]['ORB'] !== 0 ? 'border-pretty-red dark:border-pretty-red' : 'border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550' }} {{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} w-16 appearance-none rounded text-sm | py-1.5 px-2.5 | bg-white dark:bg-gray-700 | border | focus:outline-none px-2 {{ $local_players_stats[$key]['ORB'] == null && $local_players_stats[$key]['ORB'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="RO" wire:model="local_players_stats.{{ $key }}.ORB">
                                                <p class="{{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} {{ $show_players_stats_totals_inline ?: 'hidden' }} text-center text-xs pt-1 text-gray-500">Total: {{ $local_players_stats_totals['ORB'] }}</p>
                                            </td>
                                            <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                                <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ $local_players_stats[$key]['PF'] == null && $local_players_stats[$key]['PF'] !== 0 ? 'border-pretty-red dark:border-pretty-red' : 'border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550' }} {{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} w-16 appearance-none rounded text-sm | py-1.5 px-2.5 | bg-white dark:bg-gray-700 | border | focus:outline-none px-2 {{ $local_players_stats[$key]['PF'] == null && $local_players_stats[$key]['PF'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="FP" wire:model="local_players_stats.{{ $key }}.PF">
                                                <p class="{{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} {{ $show_players_stats_totals_inline ?: 'hidden' }} text-center text-xs pt-1 text-gray-500">Total: {{ $local_players_stats_totals['PF'] }}</p>
                                            </td>
                                            <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                                ...
                                                <p class="{{ $local_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} {{ $show_players_stats_totals_inline ?: 'hidden' }} text-center text-xs pt-1 text-gray-500">Total: {{ $local_players_stats_totals['ML'] }}</p>
                                            </td>
                            ...
                            <tr class="{{ $show_players_stats_totals_under ?: 'hidden' }} border-t border-gray-150 dark:border-gray-650">
                                <td class="{{ $show_players_stats_totals_under ?: 'hidden' }} truncate py-1.5 text-left bg-white dark:bg-gray-750 w-48 md:w-60 min-w-48 md:min-w-60 sticky left-0 font-bold">TOTALES</td>
