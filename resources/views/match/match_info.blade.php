{{-- @if ($match->localTeam_playerTotals() && $match->visitorTeam_playerTotals() && $match->localTeam_teamTotals() && $match->visitorTeam_teamTotals()) --}}
	<div class="bg-white dark:bg-gray-750 border border-gray-150 dark:border-transparent shadow-md rounded mx-3 md:mx-0 my-6">
		<div class="px-3 py-1">
			...
			<div class="flex flex-col py-0.5 md:py-1.5 border-b border-gray-150 dark:border-gray-650">
				<div class="flex items-center">
					<p class="w-10 md:w-12 lg:w-16 text-left md:pl-3 text-sm md:text-base lg:text-xl font-bold {{ $match->localTeam_teamTotals() && $match->localTeam_teamTotals()->zone > $match->visitorTeam_teamTotals()->zone ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
					...
					<p class="w-10 md:w-12 lg:w-16 text-right md:pr-3 text-sm md:text-base lg:text-xl font-bold {{ $match->visitorTeam_teamTotals() && $match->visitorTeam_teamTotals()->zone > $match->localTeam_teamTotals()->zone ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
			...
			<div class="flex flex-col py-0.5 md:py-1.5 border-b border-gray-150 dark:border-gray-650">
				<div class="flex items-center">
					<p class="w-10 md:w-12 lg:w-16 text-left md:pl-3 text-sm md:text-base lg:text-xl font-bold {{ $match->localTeam_teamTotals() && $match->localTeam_teamTotals()->second_oportunity > $match->visitorTeam_teamTotals()->second_oportunity ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
					...
					<p class="w-10 md:w-12 lg:w-16 text-right md:pr-3 text-sm md:text-base lg:text-xl font-bold {{ $match->visitorTeam_teamTotals() && $match->visitorTeam_teamTotals()->second_oportunity > $match->localTeam_teamTotals()->second_oportunity ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
			...
			<div class="flex flex-col py-0.5 md:py-1.5 border-b border-gray-150 dark:border-gray-650">
				<div class="flex items-center">
					<p class="w-10 md:w-12 lg:w-16 text-left md:pl-3 text-sm md:text-base lg:text-xl font-bold {{ $match->localTeam_teamTotals() && $match->localTeam_teamTotals()->substitute > $match->visitorTeam_teamTotals()->substitute ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
					...
					<p class="w-10 md:w-12 lg:w-16 text-right md:pr-3 text-sm md:text-base lg:text-xl font-bold {{ $match->visitorTeam_teamTotals() && $match->visitorTeam_teamTotals()->substitute > $match->localTeam_teamTotals()->substitute ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
			...
			<div class="flex flex-col py-0.5 md:py-1.5 border-b border-gray-150 dark:border-gray-650">
				<div class="flex items-center">
					<p class="w-10 md:w-12 lg:w-16 text-left md:pl-3 text-sm md:text-base lg:text-xl font-bold {{ $match->localTeam_teamTotals() && $match->localTeam_teamTotals()->AST > $match->visitorTeam_teamTotals()->AST ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
					...
					<p class="w-10 md:w-12 lg:w-16 text-right md:pr-3 text-sm md:text-base lg:text-xl font-bold {{ $match->visitorTeam_teamTotals() && $match->visitorTeam_teamTotals()->AST > $match->localTeam_teamTotals()->AST ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
			...
			<div class="flex flex-col py-0.5 md:py-1.5 border-b border-gray-150 dark:border-gray-650">
				<div class="flex items-center">
					...
					<p class="w-10 md:w-12 lg:w-16 text-right md:pr-3 text-sm md:text-base lg:text-xl font-bold {{ $match->visitorTeam_teamTotals() && $match->visitorTeam_teamTotals()->DRB + $match->visitorTeam_teamTotals()->ORB > $match->localTeam_teamTotals()->DRB + $match->visitorTeam_teamTotals()->ORB ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
			...
			<div class="flex flex-col py-0.5 md:py-1.5 border-b border-gray-150 dark:border-gray-650">
				<div class="flex items-center">
					<p class="w-10 md:w-12 lg:w-16 text-left md:pl-3 text-sm md:text-base lg:text-xl font-bold {{ $match->localTeam_teamTotals() && $match->localTeam_teamTotals()->ORB > $match->visitorTeam_teamTotals()->ORB ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
					...
					<p class="w-10 md:w-12 lg:w-16 text-right md:pr-3 text-sm md:text-base lg:text-xl font-bold {{ $match->visitorTeam_teamTotals() && $match->visitorTeam_teamTotals()->ORB > $match->localTeam_teamTotals()->ORB ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
			...
			<div class="flex flex-col py-0.5 md:py-1.5 border-b border-gray-150 dark:border-gray-650">
				<div class="flex items-center">
					<p class="w-10 md:w-12 lg:w-16 text-left md:pl-3 text-sm md:text-base lg:text-xl font-bold {{ $match->localTeam_teamTotals() && $match->localTeam_teamTotals()->STL > $match->visitorTeam_teamTotals()->STL ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
					...
					<p class="w-10 md:w-12 lg:w-16 text-right md:pr-3 text-sm md:text-base lg:text-xl font-bold {{ $match->visitorTeam_teamTotals() && $match->visitorTeam_teamTotals()->STL > $match->localTeam_teamTotals()->STL ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
			...
			<div class="flex flex-col py-0.5 md:py-1.5 border-b border-gray-150 dark:border-gray-650">
				<div class="flex items-center">
					<p class="w-10 md:w-12 lg:w-16 text-left md:pl-3 text-sm md:text-base lg:text-xl font-bold {{ $match->localTeam_teamTotals() && $match->localTeam_teamTotals()->BLK > $match->visitorTeam_teamTotals()->BLK ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
					...
					<p class="w-10 md:w-12 lg:w-16 text-right md:pr-3 text-sm md:text-base lg:text-xl font-bold {{ $match->visitorTeam_teamTotals() && $match->visitorTeam_teamTotals()->BLK > $match->localTeam_teamTotals()->BLK ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
			...
			<div class="flex flex-col py-0.5 md:py-1.5 border-b border-gray-150 dark:border-gray-650">
				<div class="flex items-center">
					<p class="w-10 md:w-12 lg:w-16 text-left md:pl-3 text-sm md:text-base lg:text-xl font-bold {{ $match->localTeam_teamTotals() && $match->localTeam_teamTotals()->LOS < $match->visitorTeam_teamTotals()->LOS ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
					...
					<p class="w-10 md:w-12 lg:w-16 text-right md:pr-3 text-sm md:text-base lg:text-xl font-bold {{ $match->visitorTeam_teamTotals() && $match->visitorTeam_teamTotals()->LOS < $match->localTeam_teamTotals()->LOS ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
			...
			<div class="flex flex-col py-0.5 md:py-1.5 border-b border-gray-150 dark:border-gray-650">
				<div class="flex items-center">
					<p class="w-10 md:w-12 lg:w-16 text-left md:pl-3 text-sm md:text-base lg:text-xl font-bold {{ $match->localTeam_teamTotals() && $match->localTeam_teamTotals()->PF < $match->visitorTeam_teamTotals()->PF ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
					...
					<p class="w-10 md:w-12 lg:w-16 text-right md:pr-3 text-sm md:text-base lg:text-xl font-bold {{ $match->visitorTeam_teamTotals() && $match->visitorTeam_teamTotals()->PF < $match->localTeam_teamTotals()->PF ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
			...
			<div class="flex flex-col py-0.5 md:py-1.5">
				<div class="flex items-center">
					<p class="w-10 md:w-12 lg:w-16 text-left md:pl-3 text-sm md:text-base lg:text-xl font-bold {{ $match->localTeam_teamTotals() && $match->localTeam_teamTotals()->advantage > $match->visitorTeam_teamTotals()->advantage ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
					...
					<p class="w-10 md:w-12 lg:w-16 text-right md:pr-3 text-sm md:text-base lg:text-xl font-bold {{ $match->visitorTeam_teamTotals() && $match->visitorTeam_teamTotals()->advantage > $match->localTeam_teamTotals()->advantage ? 'text-black dark:text-yellow-400' : 'text-gray-500 dark:text-gray-300' }}">
