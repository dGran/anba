        ...
        <div class="bg-white dark:bg-gray-750 overflow-x-auto">
            <div class="inline-flex">
                ...
                <div class="flex flex-col pr-3" style="width: 135px">
                    ...
                    <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="-" class="appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none {{ ($visitor_team_stats[0]['counterattack'] == null && $visitor_team_stats[0]['counterattack'] !== 0) ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_team_stats[0]['counterattack'] == null && $visitor_team_stats[0]['counterattack'] !== 0 ? 'bg-gray-50 dark:bg-gray-650': '' }}" wire:model="visitor_team_stats.{{ 0 }}.counterattack">
                </div>
                <div class="flex flex-col pr-3" style="width: 135px">
                    <label class="uppercase mr-3 mb-1 pl-1" style="font-size: .8em; font-weight: 500; letter-spacing: 0.05em;">pts. Zona</label>
                    <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="-" class="appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none {{ ($visitor_team_stats[0]['zone'] == null && $visitor_team_stats[0]['zone'] !== 0) || $visitor_team_stats[0]['zone'] > 200 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_team_stats[0]['zone'] == null && $visitor_team_stats[0]['zone'] !== 0 ? 'bg-gray-50 dark:bg-gray-650': '' }}" wire:model="visitor_team_stats.{{ 0 }}.zone">
                </div>
                <div class="flex flex-col pr-3" style="width: 135px">
                    <label class="uppercase mr-3 mb-1 pl-1" style="font-size: .8em; font-weight: 500; letter-spacing: 0.05em;">pts. 2da</label>
                    <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="-" class="appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none {{ ($visitor_team_stats[0]['second_oportunity'] == null && $visitor_team_stats[0]['second_oportunity'] !== 0) || $visitor_team_stats[0]['second_oportunity'] > 150 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_team_stats[0]['second_oportunity'] == null && $visitor_team_stats[0]['second_oportunity'] !== 0 ? 'bg-gray-50 dark:bg-gray-650': '' }}" wire:model="visitor_team_stats.{{ 0 }}.second_oportunity">
                </div>
                <div class="flex flex-col pr-3" style="width: 135px">
                    <label class="uppercase mr-3 mb-1 pl-1" style="font-size: .8em; font-weight: 500; letter-spacing: 0.05em;">pts. Suplentes</label>
                    <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="-" class="appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none {{ ($visitor_team_stats[0]['substitute'] == null && $visitor_team_stats[0]['substitute'] !== 0) || $visitor_team_stats[0]['substitute'] > 200 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_team_stats[0]['substitute'] == null && $visitor_team_stats[0]['substitute'] !== 0 ? 'bg-gray-50 dark:bg-gray-650': '' }}" wire:model="visitor_team_stats.{{ 0 }}.substitute">
                </div>
                <div class="flex flex-col pr-3" style="width: 135px">
                    <label class="uppercase mr-3 mb-1 pl-1" style="font-size: .8em; font-weight: 500; letter-spacing: 0.05em;">Asistencias</label>
                    <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="-" class="appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none {{ ($visitor_team_stats[0]['AST'] == null && $visitor_team_stats[0]['AST'] !== 0) || $visitor_team_stats[0]['AST'] > 60 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_team_stats[0]['AST'] == null && $visitor_team_stats[0]['AST'] !== 0 ? 'bg-gray-50 dark:bg-gray-650': '' }}" wire:model="visitor_team_stats.{{ 0 }}.AST">
                </div>
                <div class="flex flex-col pr-3" style="width: 135px">
                    <label class="uppercase mr-3 mb-1 pl-1" style="font-size: .8em; font-weight: 500; letter-spacing: 0.05em;">rebotes OF</label>
                    <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="-" class="appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none {{ ($visitor_team_stats[0]['ORB'] == null && $visitor_team_stats[0]['ORB'] !== 0) || $total_reb > 150 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_team_stats[0]['ORB'] == null && $visitor_team_stats[0]['ORB'] !== 0 ? 'bg-gray-50 dark:bg-gray-650': '' }}" wire:model="visitor_team_stats.{{ 0 }}.ORB">
                </div>
                <div class="flex flex-col pr-3" style="width: 135px">
                    <label class="uppercase mr-3 mb-1 pl-1" style="font-size: .8em; font-weight: 500; letter-spacing: 0.05em;">rebotes DEF</label>
                    <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="-" class="appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none {{ ($visitor_team_stats[0]['DRB'] == null && $visitor_team_stats[0]['DRB'] !== 0) || $total_reb > 150 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_team_stats[0]['DRB'] == null && $visitor_team_stats[0]['DRB'] !== 0 ? 'bg-gray-50 dark:bg-gray-650': '' }}" wire:model="visitor_team_stats.{{ 0 }}.DRB">
                </div>
                <div class="flex flex-col pr-3" style="width: 135px">
                    <label class="uppercase mr-3 mb-1 pl-1" style="font-size: .8em; font-weight: 500; letter-spacing: 0.05em;">robos</label>
                    <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="-" class="appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none {{ ($visitor_team_stats[0]['STL'] == null && $visitor_team_stats[0]['STL'] !== 0) || $visitor_team_stats[0]['STL'] > 60 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_team_stats[0]['STL'] == null && $visitor_team_stats[0]['STL'] !== 0 ? 'bg-gray-50 dark:bg-gray-650': '' }}" wire:model="visitor_team_stats.{{ 0 }}.STL">
                </div>
                <div class="flex flex-col pr-3" style="width: 135px">
                    <label class="uppercase mr-3 mb-1 pl-1" style="font-size: .8em; font-weight: 500; letter-spacing: 0.05em;">tapones</label>
                    <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="-" class="appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none {{ ($visitor_team_stats[0]['BLK'] == null && $visitor_team_stats[0]['BLK'] !== 0) || $visitor_team_stats[0]['BLK'] > 50 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_team_stats[0]['BLK'] == null && $visitor_team_stats[0]['BLK'] !== 0 ? 'bg-gray-50 dark:bg-gray-650': '' }}" wire:model="visitor_team_stats.{{ 0 }}.BLK">
                </div>
                <div class="flex flex-col pr-3" style="width: 135px">
                    <label class="uppercase mr-3 mb-1 pl-1" style="font-size: .8em; font-weight: 500; letter-spacing: 0.05em;">pérdidas</label>
                    <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="-" class="appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none {{ ($visitor_team_stats[0]['LOS'] == null && $visitor_team_stats[0]['LOS'] !== 0) || $visitor_team_stats[0]['LOS'] > 125 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_team_stats[0]['LOS'] == null && $visitor_team_stats[0]['LOS'] !== 0 ? 'bg-gray-50 dark:bg-gray-650': '' }}" wire:model="visitor_team_stats.{{ 0 }}.LOS">
                </div>
                <div class="flex flex-col pr-3" style="width: 135px">
                    <label class="uppercase mr-3 mb-1 pl-1" style="font-size: .8em; font-weight: 500; letter-spacing: 0.05em;">faltas</label>
                    <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="-" class="appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none {{ ($visitor_team_stats[0]['PF'] == null && $visitor_team_stats[0]['PF'] !== 0) ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_team_stats[0]['PF'] == null && $visitor_team_stats[0]['PF'] !== 0 ? 'bg-gray-50 dark:bg-gray-650': '' }}" wire:model="visitor_team_stats.{{ 0 }}.PF">
                </div>
                <div class="flex flex-col" style="width: 135px">
                    ...
                    <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder="-" class="appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none {{ ($visitor_team_stats[0]['advantage'] == null && $visitor_team_stats[0]['advantage'] !== 0) || $visitor_team_stats[0]['advantage'] > 200 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_team_stats[0]['advantage'] == null && $visitor_team_stats[0]['advantage'] !== 0 ? 'bg-gray-50 dark:bg-gray-650': '' }}" wire:model="visitor_team_stats.{{ 0 }}.advantage">
                </div>
            </div>
        </div>
                                ...
                                <tr class="border-t border-gray-150 dark:border-gray-650">
                                    ...
                                    @else
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="1" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['MIN'] == null ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.MIN">
                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($visitor_players_stats[$key]['PTS'] == null && $visitor_players_stats[$key]['PTS'] !== 0) || $visitor_players_stats[$key]['PTS'] > 150 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['PTS'] == null && $visitor_players_stats[$key]['PTS'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.PTS">
                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($visitor_players_stats[$key]['REB'] == null && $visitor_players_stats[$key]['REB'] !== 0) || $visitor_players_stats[$key]['REB'] > 75 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['REB'] == null && $visitor_players_stats[$key]['REB'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.REB">
                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($visitor_players_stats[$key]['AST'] == null && $visitor_players_stats[$key]['AST'] !== 0) || $visitor_players_stats[$key]['AST'] > 55 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['AST'] == null && $visitor_players_stats[$key]['AST'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.AST">
                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($visitor_players_stats[$key]['STL'] == null && $visitor_players_stats[$key]['STL'] !== 0) || $visitor_players_stats[$key]['STL'] > 30 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['STL'] == null && $visitor_players_stats[$key]['STL'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.STL">
                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($visitor_players_stats[$key]['BLK'] == null && $visitor_players_stats[$key]['BLK'] !== 0) || $visitor_players_stats[$key]['BLK'] > 25 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['BLK'] == null && $visitor_players_stats[$key]['BLK'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.BLK">
                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($visitor_players_stats[$key]['LOS'] == null && $visitor_players_stats[$key]['LOS'] !== 0) || $visitor_players_stats[$key]['LOS'] > 50 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['LOS'] == null && $visitor_players_stats[$key]['LOS'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.LOS">
                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($visitor_players_stats[$key]['FGM'] == null && $visitor_players_stats[$key]['FGM'] !== 0) || ($visitor_players_stats[$key]['FGM'] > $visitor_players_stats[$key]['FGA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['FGM'] == null && $visitor_players_stats[$key]['FGM'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.FGM">

                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($visitor_players_stats[$key]['FGA'] == null && $visitor_players_stats[$key]['FGA'] !== 0) || ($visitor_players_stats[$key]['FGM'] > $visitor_players_stats[$key]['FGA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['FGA'] == null && $visitor_players_stats[$key]['FGA'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.FGA">
                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($visitor_players_stats[$key]['TPM'] == null && $visitor_players_stats[$key]['TPM'] !== 0) || ($visitor_players_stats[$key]['TPM'] > $visitor_players_stats[$key]['TPA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['TPM'] == null && $visitor_players_stats[$key]['TPM'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.TPM">
                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($visitor_players_stats[$key]['TPA'] == null && $visitor_players_stats[$key]['TPA'] !== 0) || ($visitor_players_stats[$key]['TPM'] > $visitor_players_stats[$key]['TPA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['TPA'] == null && $visitor_players_stats[$key]['TPA'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.TPA">
                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($visitor_players_stats[$key]['FTM'] == null && $visitor_players_stats[$key]['FTM'] !== 0) || ($visitor_players_stats[$key]['FTM'] > $visitor_players_stats[$key]['FTA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['FTM'] == null && $visitor_players_stats[$key]['FTM'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.FTM">
                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($visitor_players_stats[$key]['FTA'] == null && $visitor_players_stats[$key]['FTA'] !== 0) || ($visitor_players_stats[$key]['FTM'] > $visitor_players_stats[$key]['FTA']) || ($field_shots_M > 99 || $field_shots_A > 99) ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['FTA'] == null && $visitor_players_stats[$key]['FTA'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.FTA">
                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ $visitor_players_stats[$key]['ORB'] == null && $visitor_players_stats[$key]['ORB'] !== 0 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['ORB'] == null && $visitor_players_stats[$key]['ORB'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.ORB">
                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="0" max="99" maxlength = "2" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ $visitor_players_stats[$key]['PF'] == null && $visitor_players_stats[$key]['PF'] !== 0 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['PF'] == null && $visitor_players_stats[$key]['PF'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.PF">
                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
                                            <input type="number" min="0" max="999" maxlength = "3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="{{ ($visitor_players_stats[$key]['ML'] == null && $visitor_players_stats[$key]['ML'] !== 0) || $visitor_players_stats[$key]['ML'] > 150 ? 'border-pretty-red dark:border-pretty-red' : '' }} {{ $visitor_players_stats[$key]['MIN'] > 0 ? 'block' : 'hidden' }} appearance-none rounded text-sm | py-1.5 px-3 | bg-white dark:bg-gray-700 | border border-gray-300 dark:border-gray-850 focus:border-gray-400 hover:border-gray-400 dark:focus:border-gray-550 dark:hover:border-gray-550 | focus:outline-none px-2 {{ $visitor_players_stats[$key]['ML'] == null && $visitor_players_stats[$key]['ML'] !== 0 ? 'bg-gray-50 dark:bg-gray-650' : '' }}" placeholder="-" wire:model="visitor_players_stats.{{ $key }}.ML">
                                        </td>
                                        <td class="w-14 px-1.5" style="min-width: 2.5rem">
