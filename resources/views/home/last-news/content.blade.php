        ...
        @foreach ($posts as $post)
            <div class="flex justify-between p-4 border-b border-gray-200 dark:border-gray-650" wire:loading.class="opacity-50">
                ...
                @if ($post->type == "resultados" && $post->match)
                    <figure class="h-20 w-20 md:h-24 md:w-24 rounded-md shadow-md p-0.5 bg-gray-50 dark:bg-gray-650 border-2 border-gray-200 dark:border-gray-650 relative" style="border-color: {{ $post->match->winner()->team->color }}">
