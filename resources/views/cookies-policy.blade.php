<x-app-layout>
    <x-slot name="header">
    	...
    	<div class="max-w-7xl mx-auto px-1 sm:px-3 md:px-6 lg:px-8 my-8 flex">
            <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-md sm:rounded-lg mx-3 md:mx-0 p-6 rounded-md">
                <p>
