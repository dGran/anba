<x-app-layout>
    <x-slot name="header">
    	...
    	<div class="max-w-7xl mx-auto md:px-1 sm:px-3 md:px-6 lg:px-8 md:my-8 flex border-t border-gray-200 dark:border-gray-700 md:border-transparent">
            <div class="bg-white dark:bg-gray-900 overflow-hidden md:shadow-md md:rounded-md md:mx-0 p-6">
                <p>
                ...
                <h4 class="text-pretty-red py-4 font-bold text-xl">
                	Información general
                </h4>
                <p>
                ...
                <ul class="py-2 list-disc list-inside">
                	...
                	<li class="py-1">
                		<strong>Cookies de terceros:</strong> Son aquéllas que se envían al equipo terminal del usuario desde un equipo o dominio que no es gestionado por el editor, sino por otra entidad que trata los datos obtenidos través de las cookies.
                	</li>
                </ul>
                <p>
