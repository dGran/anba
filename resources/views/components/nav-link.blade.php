...
$classes = ($active ?? false)
            ? 'uppercase inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-dark-link focus:outline-none transition duration-150 ease-in-out pointer-events-none'
