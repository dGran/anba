...
class Player_manage extends Component
{
    ...
    public $statsPerGame_order_direction = "desc";

    public $statsTotals_phase = "regular";
    public $statsTotals_order = "AVG_PTS";
    public $statsTotals_order_direction = "desc";

    public $statsAdvanced_phase = "regular";
    public $statsAdvanced_order = "AVG_PTS";
    public $statsAdvanced_order_direction = "desc";

    public function statsPerGame_change_order($statsPerGame_order)
    {
        if ($statsPerGame_order != 'seasons.name' && $statsPerGame_order != 'team_name' && $statsPerGame_order != 'teams.short_name' && $statsPerGame_order != 'AGE' && $statsPerGame_order != 'PJ' && $statsPerGame_order != 'PT' && $statsPerGame_order != 'PER_FG' && $statsPerGame_order != 'PER_TP' && $statsPerGame_order != 'PER_FT') {
